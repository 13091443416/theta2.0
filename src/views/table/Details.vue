  ...
  <div>
    ...
    <div class="right-sou">
      ...
      <div style="position: relative;">
        <router-link :to="{ name: '详情', params: { id:$route.params.id}}">
          <el-button
            type="success"
        ...
        <el-tabs v-model="activeName" @tab-click="handleClick" class="tap" type="border-card">
          <el-tab-pane lazy label="个人信息" key="1" name="1">
            <div class="tap-data">
              ...
              <Gerenfo v-if="$route.params.id" :did="$route.params.id"/>
              <Gerenfo v-else :did="$route.query.id"/>
            </div>
          </el-tab-pane>
          <el-tab-pane lazy label="在院信息" key="2" name="2">
            <div class="tap-data">
              <Zaiyuan v-if="$route.params.id" :did="$route.params.id"/>
              <Zaiyuan v-else :did="$route.query.id"/>
            </div>
          </el-tab-pane>
          ...
          <el-tab-pane lazy label="智能设备" key="7" name="7">
            <div class="tap-data">
              ...
              <Equipment v-if="$route.params.id" :id="$route.params.id"/>
              <Equipment v-else :did="$route.query.id"/>
            </div>
          </el-tab-pane>
          <el-tab-pane lazy label="附件管理" key="8" name="8">
            <div class="tap-data">
              <Enclosure v-if="$route.params.id" :did="$route.params.id"/>
              <Enclosure v-else :did="$route.query.id"/>
            </div>
          </el-tab-pane>
        </el-tabs>
      </div>
